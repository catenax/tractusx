...
export default class Aspect extends React.Component<any, any> {
  ...
  constructor(props) {
    ...
    this.state = {
      params: params,
      value: `App Connector Session ${JSON.stringify(params)}`
    };
  ...
  render() {
    ...
    return(
      <div className='h100pc df fdc p44'>
        {this.props.history && <BackLink history={this.props.history} />}
        <div className='df fdc aife mb20 w100pc'>
