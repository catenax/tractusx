...
public class UpdatePartAspectTest extends BrokerProxyIntegrationTestBase {
    ...
    private static Stream<Arguments> provideInvalidAspects() {
        return Stream.of(
                ...
                Arguments.of("Too many aspects", IntStream.rangeClosed(0, INPUT_FIELD_MAX_LENGTH).mapToObj(i -> generateDto.partAspect()).collect(Collectors.toList()), List.of("aspects:size must be between 1 and 10000")),
