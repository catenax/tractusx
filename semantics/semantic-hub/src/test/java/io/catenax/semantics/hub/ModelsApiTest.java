...
public class ModelsApiTest extends AbstractModelsApiTest{
   ...
   public void testGetModelsExpectSuccess() throws Exception {
      String urnPrefix = "urn:bamm:io.catenax:1.0.0#";
      mvc.perform(
   ...
   public void testSaveValidModelExpectSuccess() throws Exception {
      String urnPrefix = "urn:bamm:io.catenax.valid.save:2.0.0#";
      mvc.perform(
   ...
   public void testGenerateJsonSchemaExpectSuccess() throws Exception {
      ...
      mvc.perform(
         ...
         .andExpect( content().json(
               "{\"$schema\":\"http://json-schema.org/draft-04/schema\",\"type\":\"object\",\"components\":{\"schemas\":{\"urn_bamm_io.openmanufacturing_characteristic_1.0.0_Boolean\":{\"type\":\"boolean\"},\"urn_bamm_io.catenax.model.status.transition_2.0.0_WarningLevel\":{\"type\":\"string\",\"enum\":[\"green\",\"yellow\",\"red\"]},\"urn_bamm_io.catenax.model.status.transition_2.0.0_Coordinate\":{\"type\":\"number\"},\"SpatialPositionCharacteristic\":{\"type\":\"object\",\"properties\":{\"x\":{\"$ref\":\"#/components/schemas/urn_bamm_io.catenax.model.status.transition_2.0.0_Coordinate\"},\"y\":{\"$ref\":\"#/components/schemas/urn_bamm_io.catenax.model.status.transition_2.0.0_Coordinate\"},\"z\":{\"$ref\":\"#/components/schemas/urn_bamm_io.catenax.model.status.transition_2.0.0_Coordinate\"}},\"required\":[\"x\",\"y\"]}}},\"properties\":{\"moving\":{\"$ref\":\"#/components/schemas/urn_bamm_io.openmanufacturing_characteristic_1.0.0_Boolean\"},\"speedLimitWarning\":{\"$ref\":\"#/components/schemas/urn_bamm_io.catenax.model.status.transition_2.0.0_WarningLevel\"},\"position\":{\"$ref\":\"#/components/schemas/SpatialPositionCharacteristic\"}},\"required\":[\"moving\",\"speedLimitWarning\",\"position\"]}" ) )
         .andExpect( status().isOk() );
   }
   ...
   public void testDeleteEndpointWithNotExistingModelExpectNotFound() throws Exception {
      mvc.perform(
               MockMvcRequestBuilders.delete(
                     "/api/v1/models/{urn}",
                     "urn:bamm:io.catenax.notexistingpackage:2.0.0#" )
                       .with(jwtTokenFactory.allRoles())
         )
         .andDo( MockMvcResultHandlers.print() )
   ...
   public void testGenerateOpenApiEndpointSpecExpectSuccess() throws Exception {
      String urnPrefix = "urn:bamm:io.catenax.testopenapi:1.0.0#";
   ...
   public class StateTransitionTests{
      ...
      public void testModelStatusTransitionForPost() throws Exception {
         String urnPrefix = "urn:bamm:io.catenax.model.status.transition.post:2.0.0#";
         ...
         mvc.perform(delete(urnPrefix))
                 ...
                 .andExpect( jsonPath( "$.error.message", is(
                         "The package urn:bamm:io.catenax.model.status.transition.post:2.0.0# is already in status RELEASED and cannot be deleted." ) ) );

         // transition from released to draft is not allowed
         mvc.perform(post( TestUtils.createValidModelRequest(urnPrefix),"DRAFT") )
                 .andExpect( jsonPath( "$.error.message", is(
                         "The package urn:bamm:io.catenax.model.status.transition.post:2.0.0# is already in status RELEASED and cannot be modified. Only a transition to DEPRECATED is possible." ) ) )
                 .andExpect( status().isBadRequest() );
      ...
      public void testModelStatusTransitionForPut() throws Exception {
         String urnPrefix = "urn:bamm:io.catenax.model.status.transition.put:2.0.0#";
         ...
         mvc.perform(delete(urnPrefix))
                 ...
                 .andExpect(status().isBadRequest())
                 .andExpect( jsonPath( "$.error.message", is(
                         "The package urn:bamm:io.catenax.model.status.transition.put:2.0.0# is already in status RELEASED and cannot be deleted." ) ) );

         // transition from released to draft is not allowed
         mvc.perform(put( TestUtils.createValidModelRequest(urnPrefix), "DRAFT") )
                 .andExpect( jsonPath( "$.error.message", is(
                         "The package urn:bamm:io.catenax.model.status.transition.put:2.0.0# is already in status RELEASED and cannot be modified. Only a transition to DEPRECATED is possible." ) ) )
                 .andExpect( status().isBadRequest() );
      ...
      public void testDependentModelTransition() throws Exception {
        String urnPrefix = "urn:bamm:io.catenax.model.status.transitionWithDependency:1.0.0#";
