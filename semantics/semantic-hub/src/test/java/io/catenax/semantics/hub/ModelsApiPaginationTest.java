...
public class ModelsApiPaginationTest extends AbstractModelsApiTest {
   ...
   public void testGetModelsWithPaginationExpectSuccess() throws Exception {
      List<String> prefixes = List.of(
              "urn:bamm:io.catenax.pagination.a:1.0.0#",
              "urn:bamm:io.catenax.pagination.b:1.0.0#",
              "urn:bamm:io.catenax.pagination.c:1.0.0#",
              "urn:bamm:io.catenax.pagination.d:1.0.0#"
      );
