...
public class ModelsApiTest {
   ...
   public void testGetModelsExpectSuccess() throws Exception {
      ...
      mvc.perform(
               MockMvcRequestBuilders.post( "/api/v1/models" )
   ...
   public void testGenerateJsonSchemaExpectSuccess() throws Exception {
      ...
      mvc.perform(
               MockMvcRequestBuilders.get( new URI(
                     "%2Fapi%2Fv1/models/urn%3Abamm%3Anet.catenax%3A1.0.0%23Movement/json-schema" ) )
         )
         .andDo( MockMvcResultHandlers.print() )
   ...
   public void testDeleteEndpointWithExistingModelPackageExpectSuccess() throws Exception {
      ...
      mvc.perform(
               MockMvcRequestBuilders.delete(
                     new URI( "%2Fapi%2Fv1/models/urn%3Abamm%3Anet.catenax.testdelete%3A3.0.0%23" ) )
         )
         .andDo( MockMvcResultHandlers.print() )
   ...
   public void testDeleteEndpointWithNotExistingModelExpectNotFound() throws Exception {
      mvc.perform(
               MockMvcRequestBuilders.delete(
                     new URI(
                           "%2Fapi%2Fv1/models/urn%3Abamm%3Anet.catenax.notexistingpackage%3A2.0.0%23" ) )
         )
         .andDo( MockMvcResultHandlers.print() )
   ...
   public void testGenerateOpenApiEndpointSpecExpectSuccess() throws Exception {
      ...
      mvc.perform(
               MockMvcRequestBuilders.get( new URI(
                     "%2Fapi%2Fv1/models/urn%3Abamm%3Anet.catenax.testopenapi%3A1.0.0%23Movement/openapi?baseUrl=example.com" ) )
         )
         .andDo( MockMvcResultHandlers.print() )
         .andExpect( content().json(
   ...
   public void testExampleGenerateExamplePayloadJsonExpectSuccess() throws Exception {
      ...
      mvc.perform(
               MockMvcRequestBuilders.get( new URI(
                     "%2Fapi%2Fv1/models/urn%3Abamm%3Anet.catenax.testjsonschema%3A1.0.0%23Movement/example-payload" ) )
         )
         .andDo( MockMvcResultHandlers.print() )
