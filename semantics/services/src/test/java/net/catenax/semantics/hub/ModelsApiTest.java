...
public class ModelsApiTest {
   ...
   public void insertNewValidModel() throws Exception {
      ...
      mvc.perform(
         ...
         .andDo( MockMvcResultHandlers.print() )
         .andExpect( MockMvcResultMatchers.content().json(
               "{\"urn\":\"urn:bamm:net.catenax:2.0.0#TestAspect\",\"version\":\"2.0.0\",\"name\":\"TestAspect\",\"type\":\"BAMM\",\"status\":\"RELEASED\"}" ) )
         .andExpect( MockMvcResultMatchers.status().isOk() );
   }
   ...
   public void insertNewInvalidModel() throws Exception {
      ...
      mvc.perform(
         ...
         .andDo( MockMvcResultHandlers.print() )
         .andExpect( MockMvcResultMatchers.jsonPath( "$.error.details.validationError1", containsString(
   ...
   public void generateJsonSchema() throws Exception {
      ...
      mvc.perform(
               MockMvcRequestBuilders.get( new URI(
                     "%2Fapi%2F" + apiVersion + "/models/urn%3Abamm%3Anet.catenax%3A1.0.0%23Movement/json-schema" ) )
         )
         .andDo( MockMvcResultHandlers.print() )
         .andExpect( MockMvcResultMatchers.content().json(
   ...
   @Test
   @Order( 7 )
   public void testModifyExistingModelInDraftStateExpectSuccess() throws Exception {
   ...
   @Test
   @Order( 8 )
   public void testModifyExistingModelInReleasedStateExpectFailure() throws Exception {
   ...
   @Test
   @Order( 9 )
   public void testDeleteEndpointWithExistingModelPackage() throws Exception {
      ...
      mvc.perform(
               MockMvcRequestBuilders.delete(
                     new URI( "%2Fapi%2F" + apiVersion + "/models/urn%3Abamm%3Anet.catenax.testdelete%3A3.0.0%23" ) )
         )
         .andDo( MockMvcResultHandlers.print() )
   ...
   public void testOpenApiEndpoint() throws Exception {
      ...
      mvc.perform(
               MockMvcRequestBuilders.get( new URI( "%2Fapi%2F" + apiVersion
                     + "/models/urn%3Abamm%3Anet.catenax.testopenapi%3A1.0.0%23Movement/openapi?baseUrl=example.com" ) )
         )
         .andDo( MockMvcResultHandlers.print() )
         .andExpect( MockMvcResultMatchers.content().json(
   ...
   public void testExamplePayloadJson() throws Exception {
      ...
      mvc.perform(
               MockMvcRequestBuilders.get( new URI(
                     "%2Fapi%2F" + apiVersion
                           + "/models/urn%3Abamm%3Anet.catenax.testjsonschema%3A1.0.0%23Movement/example-payload" ) )
         )
         .andDo( MockMvcResultHandlers.print() )
   ...
   /**
    ...
    mvc.perform(
    MockMvcRequestBuilders.get( "/api/" + apiVersion
    + "/models?nameType=bamm-c:SingleEntity&nameFilter=SpatialPositionCharacteristic" )
    .accept( MediaType.APPLICATION_JSON )
    )
    .andDo( MockMvcResultHandlers.print() )
    .andExpect( MockMvcResultMatchers.content().json(
    ...
    "/api/" + apiVersion + "/models?nameType=_DESCRIPTION_&nameFilter=Aspect%20for%20movement" )
    .accept( MediaType.APPLICATION_JSON )
    )
    .andDo( MockMvcResultHandlers.print() )
    .andExpect( MockMvcResultMatchers.content().json(
